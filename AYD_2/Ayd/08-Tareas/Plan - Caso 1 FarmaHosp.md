...
| ~~2~~ | ~~¿"Diagrama de Contexto" es del **sistema** o del **negocio**?~~ | **RESUELTA** por las diapositivas de clase: es **del sistema**, con notación propia — **elipse = El Producto**, **rectángulo = Entidades o agentes**, **flecha = Streamlines**. Hay dos ejemplos resueltos por ella. Ver [[Diagrama de contexto]] |
| ~~3~~ | ~~¿La "primera descomposición" es **un** diagrama o **uno por proceso**?~~ | **RESUELTA** por la diapositiva *"Ejemplo Primera Descomposición del Core Tienda Electrónica"*: es **UN solo diagrama** con los N procesos como CUN y **el mismo juego de actores del core**. Ver [[Guía - Caso de negocio]] |
